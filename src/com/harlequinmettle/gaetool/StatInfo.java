...
public class StatInfo {
	...
	ArrayList<TreeMap<Float, Pair>> bSizesChanges = new ArrayList<TreeMap<Float, Pair>>();
	HashMap<Pair, Integer> displaySizes = new HashMap<Pair, Integer>();
	HashMap<Pair, Pair> displaySetChanges = new HashMap<Pair, Pair>();
