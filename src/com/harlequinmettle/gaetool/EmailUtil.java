...
public class EmailUtil {
	...
	public static void sendScanResultsByEmail(String title, String to) {
		...
		try {
			...
			msg.setTo(to);
			msg.setSubject(POSTUtil.ApplicationID + "  : " + title);
			TreeMap<Float, TreeMap<Integer, Pair>> savedResults = DSBlobs
					.restoreAnalysisResults(DSBlobs.E_DS_RESULTS,
							DSBlobs.P_RESULTS);
			StringBuilder bodyText = new StringBuilder();
			int i = 0;
			for (Entry<Float, TreeMap<Integer, Pair>> ent : savedResults
					.entrySet()) {
