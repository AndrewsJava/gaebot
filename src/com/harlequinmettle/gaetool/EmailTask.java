...
//PrintWriter w = resp.getWriter();
   ...
   case SETQi:///ab@backend-test-app
	 //  EmailUtil.sendDataByEmail(Qi.QQ,TheBackend.fileTitleQ,"harlequinmettle@gmail.com");
	   EmailUtil.sendDataByEmail(Qi.QQ,TheBackend.fileTitleQ,"parelius@uw.edu");
   ...
   case SETYi:
	  // EmailUtil.sendDataByEmail(Yi.YY,TheBackend.fileTitleY,"harlequinmettle@gmail.com");
	   EmailUtil.sendDataByEmail(Yi.YY,TheBackend.fileTitleY,"parelius@uw.edu");
   ...
   case ANALYSIS_RESULTS:
	   EmailUtil.sendScanResultsByEmail( TheBackend.fileTitleY,"harlequinmettle@gmail.com");
