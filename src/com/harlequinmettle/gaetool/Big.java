...
public class Big {
	...
	static String collectAndExtract_Big_DataFromNetwork(String stock) {
		...
		if (Arrays.binarySearch(Yi.YY, stock) >= 0)
			index = "NYSE";
		...
		if (false && TheBackend.counter < 100)
			DSUtil.addToDatastoreAsText(DSUtil.DATA, stock, "data", totaldata);
	...
	static protected String keyBasedData(String addy, String[] keys) {
		for (int i = 0; i < 40; i++) {// try 40 times to get html or else return
										// #_#
			String httpdata = NetUtil.getHtml(addy);
			int counter = 0;
			String price = "";
			String yhdata = "";
			String str = httpdata;
	...
	public static String options(String stock) {
		String httpdata = NetUtil.getHtml(yahoobase + "/op?s=" + stock);
	...
	public static String pastPrices(String stock) {
		String httpdata = NetUtil.getHtml(yahoobase + "/hp?s=" + stock);
	...
	// //////////////////###################################
	public static String competitors(String stock) {
		String httpdata = NetUtil.getHtml(yahoobase + "/co?s=" + stock);
	...
	// ///////////////////////#################################
	public static String industry(String stock) {
		String httpdata = NetUtil.getHtml(yahoobase + "/in?s=" + stock);
	...
	public static String estOpinions(String stock) {
		int counting = 0;
		// Year Ago EPS //after this key substring to Revenue Est
		String httpdata = NetUtil.getHtml(yahoobase + "/ae?s=" + stock);
		String chop = "";
	...
	public static String cnnForecast(String stock) {
		...
		String httpdata = NetUtil.getHtml(fcstbase + stock);
		if (httpdata == null)
	...
	public static String statements(String addy, String[] keys,
		...
		String rval = "";
		int factor = 1;
		String chop = (NetUtil.getHtml(addy));
